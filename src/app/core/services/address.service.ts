...
import { IAddress, IAddressPayload } from '../models/addresses/address.model';
...
export class AddressService {
  ...
  addAddress(addressForm: IAddressPayload): Observable<IAddress[]> {
  ...
  updateAddress(addressId: string, addressForm: IAddressPayload): Observable<IAddress[]> {
    return this.httpClient
