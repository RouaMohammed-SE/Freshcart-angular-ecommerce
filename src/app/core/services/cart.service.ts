...
type CouponResponse = ICartResponse;
type CartLike = ICartResponse | ICartProductGuest[];
...
export class CartService {
  ...
  applyCoupon(couponName: string): Observable<CouponResponse> {
    return this.httpClient.put<CouponResponse>(`${this.baseURL}/v2/cart/applyCoupon`, { couponName });
  }
  ...
  getCartTotal(cart: CartLike): number {
