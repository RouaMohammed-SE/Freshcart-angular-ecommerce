...
import { EGYPTIAN_PHONE_PATTERN } from '../../core/constants/validators.constant';
...
export class CheckoutComponent implements OnInit {
  ...
  loadCart(): Observable<ICartResponse> {
    return this.cartService.getCurrentUserCart();
  }

  loadShippingAddresses(): Observable<IAddress[]> {
  ...
  onSubmit(): void {
    if (this.shippingAddressForm.valid) {
      ...
      const shippingAddress = this.shippingAddressForm.getRawValue() as IShippingAddress;
      this.isCash()
  ...
  createCashOrder(cartId: string, shippingAddress: IShippingAddress): void {
  ...
  createCheckoutSession(cartId: string, shippingAddress: IShippingAddress): void {
    this.isSubmitting.set(true);
    this.orderService
